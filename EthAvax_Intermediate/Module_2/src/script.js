...
const contractAddress = '0xD2C5871e3dd066640C69d6D4B110D8926d7c8d9a';
const contractABI=[
	{
		"inputs": [
			{
...
async function sendUpMessage() {
	...
	try {
		...
		console.log(`message from Faculty To Hod : ${message}`);
	} catch (error) {
		console.error(error);
...
async function sendDownMessage() {
	...
	try {
		...
		console.log(`message from Hod To Faculty : ${message}`);
	} catch (error) {
		console.error(error);
		alert('Failed to send message');
	}
